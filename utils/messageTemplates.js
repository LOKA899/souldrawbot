    ...
    createLotteryEmbed(lottery) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '🎫 Ticket Info', value: `Price: ${lottery.ticketPrice || 1} skulls\nMax per user: ${lottery.maxTicketsPerUser || 100}` },
    ...
    createCongratulationsEmbed(prize, winners, userMentions) {
        return new EmbedBuilder()
            ...
            .setDescription(
                ...
                `🎁 **Prize Won:** ${prize}\n\n` +
                `📝 Please send your Polygon/Arena-Z wallet address for prize distribution.\n\n` +
